...
# ALLOWED_HOSTS should allow localhost in development
...
INSTALLED_APPS = [
    "backend.core",  # Move this line above django.contrib.admin
...
CSRF_COOKIE_NAME = "_streamlit_xsrf"
...
# Email settings
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'  # Updated from console to smtp
EMAIL_HOST = config('EMAIL_HOST', default='smtp.gmail.com')
EMAIL_PORT = config('EMAIL_PORT', default=587, cast=int)
EMAIL_USE_TLS = config('EMAIL_USE_TLS', default=True, cast=bool)
EMAIL_HOST_USER = config('EMAIL_HOST_USER', default='')
EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD', default='')  # App password from Gmail
DEFAULT_FROM_EMAIL = EMAIL_HOST_USER  # Use the Gmail address as the default sender
